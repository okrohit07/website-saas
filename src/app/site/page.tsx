...
export default async function Home() {
  ...
  return (
    <>
      <section className="h-full w-full pt-36 md:pt-44 mt-[70px] relative flex items-center justify-center flex-col">
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-[40px]">
        ...
        <div className="flex justify-center gap-4 flex-wrap mt-6">
          {/* Temporarily hide the dynamic pricing data */}
          ...
          {/* Static placeholder cards for UI check */}
          <Card className={clsx("w-[300px] flex flex-col justify-between")}>
            ...
            <CardFooter className="flex flex-col items-start gap-4">
              ...
              <Link
                href="/agency"
                className="w-full text-center bg-primary p-2 rounded-md !bg-muted-foreground"
              >
                Get Started
              </Link>
            </CardFooter>
          ...
          <Card className={clsx("w-[300px] flex flex-col justify-between")}>
            <CardHeader>
              ...
              <CardDescription>
                All features for unlimited projects.
              </CardDescription>
            </CardHeader>
            <CardContent>
